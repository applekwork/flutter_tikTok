...
class StandardTextStyle {
  ...
  static const TextStyle normal = const TextStyle(
      fontWeight: FontWeight.w600, fontSize: SysSize.normal, inherit: true);
...
class ColorPlate {
  ...
  static const Color primary = const Color(0xFF23B38E);
  static const Color secondary = const Color(0xFF51DEC6);
  static const Color blue = const Color(0xFF3688FF);
  static const Color golden = const Color(0xff8B7961);
  static const Color dividerColor = Color(0xffeeeeee);
  static const Color paper = const Color(0xfff5f5f5);
